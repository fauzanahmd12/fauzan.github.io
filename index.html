...
<html lang="en">
  ...
  <body>
    ...
    <div class="all-body-cover">
      ...
      />
      <div class="nama">
        <h4 class="text-center fw-bold">AHMAD FAUZAN</h4>
        <h5 class="text-center">PELAJAR</h5>
      </div>
          ...
          <div class="container text-center">
            <div class="row">
              <div
                ...
                class="col-sm-4 mb-2"
              >
                HALO, Perkenalkan Nama Saya ahmad fauzan biasa di panggil fauzan 
                saya masuk jurusan TJKT pada tahun 2023 lalu, sekarang saya kelas xi TJKT
              </div>
              <div
                data-aos="fade-up"
                data-aos-duration="800"
              ...
              >
                ...
                <div class="education">
                  ...
                  <p class="startEnd">dimulai pada Jul 2014</p>
                  <button
                    type="button"
                  ...
                  <p class="startEnd">selesai pada 2020 awal</p>
                  <i class="fas fa-arrow-circle-down itemEdu"></i>
                  <!-- <i class="fas fa-arrow-circle-down itemEdu"></i> -->
                  <p class="startEnd">dimula pada juli 2020</p>
                  <button
                    type="button"
                    class="btn btn-danger itemEdu"
                    data-bs-toggle="modal"
                  ...
                  <p class="startEnd">selesai pada juni 2023</p>
                  <i class="fas fa-arrow-circle-down itemEdu"></i>
                  <!-- <i class="fas fa-arrow-circle-down itemEdu"></i> -->
                  <p class="startEnd">dimulai pada juli 2023</p>
                  <button
                    type="button"
                    class="btn btn-danger itemEdu"
                    data-bs-toggle="modal"
                  ...
                  <p class="startEnd">selesai pada juni 2026</p>
                  <i class="fas fa-arrow-circle-down itemEdu"></i>
                  <!-- <i class="fas fa-arrow-circle-down itemEdu"></i> -->
                  <p class="startEnd">Tamat Smk</p>
                  <button
                    type="button"
                    class="btn btn-danger itemEdu"
                    data-bs-toggle="modal"
                  ...
                  >
                    University teknologi bandung (Coming Soon)
                  </button>
              ...
              <div data-aos="fade-up" data-aos-duration="800" class="col-sm-4">
                HOBI saya adalah membaca komik,saya juga suka mendengarkan music di 
                sportfy dan saya juga suka mengscroll tik tok 
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-3">
            ...
            >
              ...
              <div class="card-body">
                <h5 class="card-title">Paskibra dan Osis</h5>
                <p class="card-text">
                  menjabat sebagai sekertaris paski, dan saya menjabat di osis sebagai bela negara dan wawasan kebangsaan
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-3">
            ...
            >
              ...
              <div class="card-body">
                <h5 class="card-title">lomba yang diikuti</h5>
                <p class="card-text">
                 mengikuti lomba band akustik,lomba nasyid antar kelas ,dan pernah juara 2 di lomba lkbb rri pada tahun 2023,lomba lkbb di subang jawa barat dan membawa beberapa thropy dan piala
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-3">
            ...
            >
              ...
              <div class="card-body">
                <h5 class="card-title">menginstal sistem operasi</h5>
                <p class="card-text">
                  Mampu menginstal debian dan mampu menginstal linux
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-3">
            ...
            >
              ...
              <div class="card-body">
                ...
                <p class="card-text">
                  mampu membuat situs web dengan teknologi javaScript dan CSS
                </p>
              </div>
            </div>
          </div>
    ...
    <div class="fivethContainer">
      ...
      <div class="container">
        ...
        <p class="text-center">Created by <a href="#">@Fauzanfuxzz.12</a></p>
      </div>
    </div>
